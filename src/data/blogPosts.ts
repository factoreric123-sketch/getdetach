...
export const blogPosts: BlogPost[] = [
  {
    ...
    metaDescription: "Learn what Detach app is, how it blocks social media and distracting apps, and how NFC tags help you reduce screen time.",
    excerpt: "Detach is an app blocker for iOS that helps you reduce screen time by blocking social media and distracting apps using physical NFC tags.",
    date: "2025-03-15",
    content: `
## What is Detach App?

**Detach** is an app blocker designed to help you reduce screen time by blocking social media and other distracting apps on your iPhone. Unlike traditional screen time tools, the Detach app uses physical NFC tags to create real friction between you and your phone.
...
2. **Tap your NFC tag** — When you're ready to focus, tap a physical NFC tag with your phone. This starts your blocking session. The Detach app uses Apple's Screen Time API to enforce the blocks.

3. **Stay focused** — During your session, the apps you selected are completely blocked. To end the session, you need to physically tap the NFC tag again — making it impossible to give in to a quick scroll.

## Why Detach is Different from Other App Blockers

Most app blockers rely on willpower. You can easily disable them with a few taps. The Detach app is different because it requires a **physical action** — tapping an NFC tag — to end a session. This makes the Detach app blocker far more effective at reducing screen time.
...
Learn more about [how Detach compares to other app blockers](/blog/detach-vs-other-app-blockers) or visit the [Detach app page](/detach-app) for a full overview.
  ...
  },
  {
    ...
    excerpt: "We review whether the Detach app blocker actually delivers on its promise to reduce screen time using NFC tags.",
    date: "2025-03-20",
    content: `
## Detach App Review: The App Blocker That Uses NFC Tags
...
The Detach app blocker uses Apple's Screen Time API to block apps at the system level. But here's the key difference: **you need to tap a physical NFC tag to start and end sessions**. This creates a physical barrier that's much harder to ignore than a software toggle.

When you try to open a blocked app during a session, you'll see a blocked screen. There's no "just 5 more minutes" button. The only way to unblock is to physically walk to your NFC tag and tap it.

## Does Detach Actually Reduce Screen Time?

In short: **yes**. The physical friction of needing an NFC tag makes all the difference. When you have to get up, find your tag, and tap it — you actually think about whether you really need to check that app. Most of the time, you don't.
...
- **NFC tags create real friction** — not just a software toggle
...
- **Requires NFC tag** — though you can buy one for a few dollars
...
[Download Detach](https://apps.apple.com/us/app/detach-screen-break/id6759267252) and try it yourself. Learn more on the [Detach app page](/detach-app).
  ...
  },
  {
    ...
    metaDescription: "Discover how Detach app blocks social media like Instagram, TikTok, and Twitter using NFC tags instead of willpower.",
    excerpt: "Detach doesn't rely on willpower to block social media. Instead, it uses physical NFC tags and system-level blocking to keep you off distracting apps.",
    date: "2025-03-25",
    content: `
...
Here's what makes the Detach app blocker unique: to start and end a blocking session, you need to physically tap an NFC tag. Place the tag somewhere away from your desk — maybe in another room. Now, to unblock social media, you'd need to:

1. Get up from what you're doing
2. Walk to where your NFC tag is
3. Tap your phone to the tag
...
The **Detach app** uses **physical friction**. You need to tap a physical NFC tag to start and end blocking sessions. You can't bypass this with a quick tap — you need to physically interact with a tag.
...
### 1. NFC Tags Create Real Commitment

When you tap an NFC tag to start a Detach session, you're making a physical commitment. Other app blockers let you disable blocking with a few taps on your screen. The Detach app blocker requires you to go find your tag.
