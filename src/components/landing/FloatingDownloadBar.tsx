  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 px-4 pb-4 pt-2">
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center gap-3 rounded-2xl border border-border/60 bg-card/95 backdrop-blur-xl px-4 py-3 shadow-2xl">
          <img
            src={logo}
            alt="Detach"
            width={40}
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 shrink-0 bg-primary text-primary-foreground px-4 py-2.5 rounded-full text-sm font-semibold hover:opacity-90 transition-opacity"
          >
