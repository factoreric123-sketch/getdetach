  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        >
          Detach locks your apps and websites so you can't open them. A small physical card that you leave at home is the only way to end a session, making it impossible to give in.
        </motion.p>
