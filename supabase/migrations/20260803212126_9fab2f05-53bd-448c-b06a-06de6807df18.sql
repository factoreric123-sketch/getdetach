-- Pin search_path on internal helper functions
...
-- These SECURITY DEFINER helpers are internal (called by edge functions with the
-- service role and by cron); no public or end-user caller should execute them.
